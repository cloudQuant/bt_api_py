...
| 参数 | 类型 | 必需 | 描述 |
|------|------|------|------|
| period | ENUM | 否 | K线周期: M1,M3,M5,M15,M30,H1,H4,D1,D7,1M。默认M30 |
| sort | ENUM | 否 | ASC/DESC，默认DESC |
...
| post_only | BOOL | 否 | 仅做Maker |
| client_order_id | STRING | 否 | 客户自定义ID |
