...
class TradeMixin:
    ...
    def get_algo_order(self, algo_id=None, symbol=None, inst_type=None, extra_data=None, **kwargs):
        """Get algo order details"""
        path, params, extra_data = self._get_algo_order(algo_id, symbol, inst_type, extra_data, **kwargs)
        data = self.request(path, params=params, extra_data=extra_data)
        return data

    def async_get_algo_order(self, algo_id=None, symbol=None, inst_type=None, extra_data=None, **kwargs):
