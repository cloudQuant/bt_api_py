...
def test_okx_req_sprd_order():
    ...
    data = live_okx_swap_feed.sprd_order(sprd_id="F-USDT-BTC-USDT", side="buy", sz="1", px="0.01")
    assert isinstance(data, RequestData)
...
def test_okx_async_sprd_order():
    ...
    data_queue = queue.Queue()
    live_okx_swap_feed = init_async_feed(data_queue)
    live_okx_swap_feed.async_sprd_order(sprd_id="F-USDT-BTC-USDT", side="buy", sz="1", px="0.01")
    time.sleep(5)
    try:
        result = data_queue.get(False)
    except queue.Empty:
...
def test_okx_req_sprd_cancel_order():
    ...
    data = live_okx_swap_feed.sprd_cancel_order(sprd_id="F-USDT-BTC-USDT", order_id="12345")
    assert isinstance(data, RequestData)
...
def test_okx_async_sprd_cancel_order():
    ...
    data_queue = queue.Queue()
    live_okx_swap_feed = init_async_feed(data_queue)
    live_okx_swap_feed.async_sprd_cancel_order(sprd_id="F-USDT-BTC-USDT", order_id="12345")
    time.sleep(5)
    try:
        result = data_queue.get(False)
    except queue.Empty:
...
def test_okx_sprd_trading_with_client_order_id():
    ...
    order_data = live_okx_swap_feed.sprd_order(
        sprd_id="F-USDT-BTC-USDT", side="buy", sz="1", px="0.01", cl_ord_id=client_order_id
    )
    ...
    get_data = live_okx_swap_feed.sprd_get_order(
        sprd_id="F-USDT-BTC-USDT", client_order_id=client_order_id
    )
...
def test_okx_sprd_order_with_reduce_only():
    ...
    data = live_okx_swap_feed.sprd_order(
        sprd_id="F-USDT-BTC-USDT", side="sell", sz="1", px="0.01", reduce_only=True
    )
    assert isinstance(data, RequestData)
...
def test_okx_sprd_get_orders_pending_with_filter():
    ...
    live_okx_swap_feed = init_req_feed()
    data = live_okx_swap_feed.sprd_get_orders_pending(sprd_id="F-USDT-BTC-USDT", limit="10")
    assert isinstance(data, RequestData)
...
def test_okx_sprd_get_orders_history_with_state():
    ...
    live_okx_swap_feed = init_req_feed()
    # Get filled orders
    data = live_okx_swap_feed.sprd_get_orders_history(state="filled", limit="10")
    assert isinstance(data, RequestData)
...
def test_okx_sprd_get_trades_with_instrument():
    ...
    live_okx_swap_feed = init_req_feed()
    data = live_okx_swap_feed.sprd_get_trades(sprd_id="F-USDT-BTC-USDT", limit="10")
    assert isinstance(data, RequestData)
