...
def register_mercado_bitcoin():
    ...
    # 注册配置类
    ExchangeRegistry.register_exchange_data("MERCADO_BITCOIN___SPOT", MercadoBitcoinExchangeDataSpot)

    # 注册余额处理器
    ExchangeRegistry.register_balance_handler("MERCADO_BITCOIN___SPOT", _mercado_bitcoin_balance_handler)
