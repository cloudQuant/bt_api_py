...
class TestBitstampRequestTickerData:
    ...
    def test_init_data(self):
        ...
        ticker = BitstampRequestTickerData(data, symbol_name="btcusd", asset_type="SPOT", has_been_json_encoded=True)
        ticker.init_data()
    ...
    def test_get_all_data(self):
        """Test get_all_data."""
        ticker = BitstampRequestTickerData({}, symbol_name="btcusd", asset_type="SPOT", has_been_json_encoded=True)
