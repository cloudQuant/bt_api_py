...
class TestBitfinexRequestBarData:
    ...
    def test_init_data(self):
        ...
        bar = BitfinexRequestBarData(data, symbol_name="BTCUSD", asset_type="SPOT", has_been_json_encoded=True)
        bar.init_data()
    ...
    def test_get_all_data(self):
        ...
        bar = BitfinexRequestBarData({}, symbol_name="BTCUSD", asset_type="SPOT", has_been_json_encoded=True)
