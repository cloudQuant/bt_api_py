...
class TestValrRequestTickerData:
    ...
    def test_init_data(self):
        ...
        ticker = ValrRequestTickerData(data, symbol_name="BTCZAR", asset_type="SPOT", has_been_json_encoded=True)
        ticker.init_data()
    ...
    def test_get_all_data(self):
        ...
        ticker = ValrRequestTickerData({}, symbol_name="BTCZAR", asset_type="SPOT", has_been_json_encoded=True)
