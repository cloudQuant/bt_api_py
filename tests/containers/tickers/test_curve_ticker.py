...
class TestCurveRequestTickerData:
    ...
    def test_init_data(self):
        ...
        ticker = CurveRequestTickerData(
            data, symbol_name="USDC-USDT", asset_type="SPOT", has_been_json_encoded=True
        )
        ticker.init_data()
    ...
    def test_get_all_data(self):
        """Test get_all_data."""
        ticker = CurveRequestTickerData(
            {}, symbol_name="USDC-USDT", asset_type="SPOT", has_been_json_encoded=True
        )
