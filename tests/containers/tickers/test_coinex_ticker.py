...
class TestCoinExRequestTickerData:
    ...
    def test_init_data(self):
        ...
        ticker = CoinExRequestTickerData(data, symbol_name="BTCUSDT", asset_type="SPOT", has_been_json_encoded=True)
        ticker.init_data()
    ...
    def test_get_all_data(self):
        """Test get_all_data."""
        ticker = CoinExRequestTickerData({}, symbol_name="BTCUSDT", asset_type="SPOT", has_been_json_encoded=True)
