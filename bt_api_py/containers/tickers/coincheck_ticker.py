"""Coincheck Ticker Data Container."""
...
class CoincheckRequestTickerData(TickerData):
    """Coincheck ticker data container."""
    ...
    def __init__(
        ...
        """Initialize Coincheck ticker data container.
    ...
    def init_data(self) -> CoincheckRequestTickerData:
        """Parse Coincheck ticker response."""
        ...
        if data:
            # Coincheck returns ticker data at root level
