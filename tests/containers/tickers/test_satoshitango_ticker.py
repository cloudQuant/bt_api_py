...
class TestSatoshiTangoRequestTickerData:
    ...
    def test_init_data(self):
        ...
        ticker = SatoshiTangoRequestTickerData(data, symbol_name="BTCARS", asset_type="SPOT", has_been_json_encoded=True)
        ticker.init_data()
    ...
    def test_get_all_data(self):
        ...
        ticker = SatoshiTangoRequestTickerData({}, symbol_name="BTCARS", asset_type="SPOT", has_been_json_encoded=True)
