...
class TestBitbnsRequestTickerData:
    ...
    def test_init_data(self):
        ...
        ticker = BitbnsRequestTickerData(data, symbol_name="BTCINR", asset_type="SPOT", has_been_json_encoded=True)
        ticker.init_data()
    ...
    def test_get_all_data(self):
        ...
        ticker = BitbnsRequestTickerData({}, symbol_name="BTCINR", asset_type="SPOT", has_been_json_encoded=True)
