...
class TestBalancerRequestTickerData:
    ...
    def test_init_data(self):
        ...
        data = {"price": "50000.0"}
        ticker = BalancerRequestTickerData(
            data, symbol_name="BTC-ETH", asset_type="SPOT", has_been_json_encoded=True
        )
        ticker.init_data()
    ...
    def test_get_all_data(self):
        """Test get_all_data."""
        ticker = BalancerRequestTickerData(
            {}, symbol_name="BTC-ETH", asset_type="SPOT", has_been_json_encoded=True
        )
