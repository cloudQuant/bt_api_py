...
class TestSwyftxRequestTickerData:
    ...
    def test_init_data(self):
        ...
        ticker = SwyftxRequestTickerData(data, symbol_name="BTCAUD", asset_type="SPOT", has_been_json_encoded=True)
        ticker.init_data()
    ...
    def test_get_all_data(self):
        ...
        ticker = SwyftxRequestTickerData({}, symbol_name="BTCAUD", asset_type="SPOT", has_been_json_encoded=True)
