...
class TestBtApiUnifiedInterface:
    ...
    def test_old_methods_exist(self):
        """原有接口应保持不变"""
        old_methods = [
            'get_request_api', 'get_async_request_api', 'get_data_queue',
            'subscribe', 'download_history_bars', 'update_total_balance',
            'update_balance', 'get_cash', 'get_value', 'get_total_cash',
            'get_total_value', 'get_event_bus', 'list_exchanges',
            'list_available_exchanges', 'add_exchange', 'push_bar_data_to_queue',
        ]
    ...
    def test_unified_async_methods_exist(self):
        ...
        async_methods = [
            ...
            'async_make_order', 'async_cancel_order', 'async_cancel_all',
            'async_query_order', 'async_get_open_orders',
            'async_get_balance', 'async_get_account', 'async_get_position',
        ]
    ...
    def test_batch_methods_exist(self):
        """批量操作方法应存在"""
        batch_methods = [
            'get_all_ticks', 'get_all_balances',
