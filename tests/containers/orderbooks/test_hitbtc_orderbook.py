...
class TestHitBtcRequestOrderBookData:
    ...
    def test_init_data(self):
        ...
        orderbook = HitBtcRequestOrderBookData(data, symbol_name="BTCUSD", asset_type="SPOT", has_been_json_encoded=True)
        orderbook.init_data()
    ...
    def test_get_all_data(self):
        ...
        orderbook = HitBtcRequestOrderBookData({}, symbol_name="BTCUSD", asset_type="SPOT", has_been_json_encoded=True)
