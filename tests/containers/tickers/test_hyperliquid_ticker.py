...
class TestHyperliquidTickerData:
    ...
    def test_init_data(self):
        ...
        data = {"BTC": "50000.0"}
        ticker = HyperliquidTickerData(data, symbol_name="BTC", asset_type="SWAP", has_been_json_encoded=True)
        ticker.init_data()
    ...
    def test_get_all_data(self):
        """Test get_all_data."""
        ticker = HyperliquidTickerData({}, symbol_name="BTC", asset_type="SWAP", has_been_json_encoded=True)
