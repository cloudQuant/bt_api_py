...
**签名步骤**:
1. 拼接签名字符串: `METHOD + request_path(含query_string) + body(可选) + timestamp`
...
| limit | INT | 否 | 深度档数 (5/10/20/50, 默认20) |
...
**参数**: `market` (必需), `limit` (可选, 默认100, 最大1000)
