...
def test_imports():
    ...
    try:
        ...
        # Test exchange data
        from bt_api_py.containers.exchanges.kraken_exchange_data import KrakenExchangeData, KrakenExchangeDataSpot
        ...
        from bt_api_py.containers.balances.kraken_balance import KrakenRequestBalanceData, KrakenSpotWssBalanceData
