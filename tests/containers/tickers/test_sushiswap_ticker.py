...
class TestSushiSwapRequestTickerData:
    ...
    def test_init_data(self):
        ...
        ticker = SushiSwapRequestTickerData(data, symbol_name="SUSHI-ETH", asset_type="DEX", has_been_json_encoded=True)
        ticker.init_data()
    ...
    def test_get_all_data(self):
        ...
        ticker = SushiSwapRequestTickerData({}, symbol_name="SUSHI-ETH", asset_type="DEX", has_been_json_encoded=True)
