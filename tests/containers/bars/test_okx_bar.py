...
class TestOkxBarData:
    ...
    def test_init_data(self):
        ...
        data = [1688671955000, "50000.0", "51000.0", "49000.0", "50500.0", "1000.0", "50000000.0", "50000000.0", "1"]
        bar = OkxBarData(data, symbol_name="BTC-USDT", asset_type="SPOT", has_been_json_encoded=True)
        bar.init_data()
