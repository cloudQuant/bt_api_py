...
class TestLunoRequestTickerData:
    ...
    def test_init_data(self):
        ...
        ticker = LunoRequestTickerData(data, symbol_name="XBTZAR", asset_type="SPOT", has_been_json_encoded=True)
        ticker.init_data()
    ...
    def test_get_all_data(self):
        ...
        ticker = LunoRequestTickerData({}, symbol_name="XBTZAR", asset_type="SPOT", has_been_json_encoded=True)
