...
The `MIN_NOTIONAL` filter defines the minimum notional value allowed for an order on a symbol. An order's notional value is the `price` * `quantity`. Since `MARKET` orders have no price, the mark price is used.
  ...
  * [Symbol filters](</docs/derivatives/usds-margined-futures/common-definition#symbol-filters>)
    * [PRICE_FILTER](</docs/derivatives/usds-margined-futures/common-definition#price_filter>)
    * [LOT_SIZE](</docs/derivatives/usds-margined-futures/common-definition#lot_size>)
    * [MARKET_LOT_SIZE](</docs/derivatives/usds-margined-futures/common-definition#market_lot_size>)
    * [MAX_NUM_ORDERS](</docs/derivatives/usds-margined-futures/common-definition#max_num_orders>)
    * [MAX_NUM_ALGO_ORDERS](</docs/derivatives/usds-margined-futures/common-definition#max_num_algo_orders>)
    * [PERCENT_PRICE](</docs/derivatives/usds-margined-futures/common-definition#percent_price>)
    * [MIN_NOTIONAL](</docs/derivatives/usds-margined-futures/common-definition#min_notional>)
