...
Independent Reserve is an Australian cryptocurrency exchange with:
- Public API for market data
- Private API for trading (requires HMAC SHA256 signature)
- Supports AUD, NZD, USD, SGD fiat currencies
"""
...
def _get_independent_reserve_config():
    """Load Independent Reserve YAML configuration."""
...
class IndependentReserveExchangeData(ExchangeData):
    ...
    def __init__(self):
        ...
        self.wss_url = "wss://api.independentreserve.com"
        self.kline_periods = {
            "1m": "1m",
            "5m": "5m",
            "15m": "15m",
