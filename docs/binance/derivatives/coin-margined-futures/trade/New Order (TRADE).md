...
## Response Example
  ...
  - [API Description](</docs/derivatives/coin-margined-futures/trade#api-description>)
  - [HTTP Request](</docs/derivatives/coin-margined-futures/trade#http-request>)
  - [Request Weight(IP)](</docs/derivatives/coin-margined-futures/trade#request-weightip>)
  - [Request Parameters](</docs/derivatives/coin-margined-futures/trade#request-parameters>)
  - [Response Example](</docs/derivatives/coin-margined-futures/trade#response-example>)
