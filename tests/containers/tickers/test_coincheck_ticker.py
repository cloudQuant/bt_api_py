...
class TestCoincheckRequestTickerData:
    ...
    def test_init_data(self):
        ...
        ticker = CoincheckRequestTickerData(data, symbol_name="btc_jpy", asset_type="SPOT", has_been_json_encoded=True)
        ticker.init_data()
    ...
    def test_get_all_data(self):
        ...
        ticker = CoincheckRequestTickerData({}, symbol_name="btc_jpy", asset_type="SPOT", has_been_json_encoded=True)
