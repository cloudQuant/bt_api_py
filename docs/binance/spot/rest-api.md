...
| GET | `/api/v3/klines` | NONE | 2 | K线数据 |
| GET | `/api/v3/uiKlines` | NONE | 2 | UI优化K线 |
| GET | `/api/v3/avgPrice` | NONE | 2 | 当前均价 |
| GET | `/api/v3/ticker/24hr` | NONE | 2-80 | 24小时价格变动 |
...
| POST | `/api/v3/sor/order` | TRADE | 1 | SOR下单 |
| POST | `/api/v3/sor/order/test` | TRADE | 1/20 | 测试SOR下单 |
...
| GET | `/api/v3/myPreventedMatches` | USER_DATA | 2/20 | STP匹配记录 |
| GET | `/api/v3/myAllocations` | USER_DATA | 20 | SOR分配记录 |
