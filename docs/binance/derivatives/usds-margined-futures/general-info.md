...
It is important to**NOT**treat this as a failure operation; the execution status is**UNKNOWN**and could have been a success;
    ...
    1. If there is an error message**"Service Unavailable."**returned in the response, it means this is a failure API operation and the service might be unavailable at the moment, you need to retry later.
    2. If there is an error message**"Internal error; unable to process your request. Please try again."**returned in the response, it means this is a failure API operation and you can resend your request if you need.
...
For more information please refer to this page: [Binance API Postman](<https://github.com/binance-exchange/binance-api-postman>)
  ...
  - [SIGNED (TRADE and USER_DATA) Endpoint Security](</docs/derivatives/usds-margined-futures/general-info#signed-trade-and-user_data-endpoint-security>)
