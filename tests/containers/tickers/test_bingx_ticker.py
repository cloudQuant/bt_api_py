...
class TestBingXRequestTickerData:
    ...
    def test_init_data(self):
        ...
        ticker = BingXRequestTickerData(data, symbol_name="BTC-USDT", asset_type="SPOT", has_been_json_encoded=True)
        ticker.init_data()
    ...
    def test_get_all_data(self):
        ...
        ticker = BingXRequestTickerData({}, symbol_name="BTC-USDT", asset_type="SPOT", has_been_json_encoded=True)
