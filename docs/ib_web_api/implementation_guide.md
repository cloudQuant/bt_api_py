...
- Python 3.8+
- 网络连接（HTTPS）
- 对于个人客户：Java运行环境（用于Client Portal Gateway）

---

## 认证配置

### 方式1: Client Portal Gateway（个人客户）

**步骤**:

1. 下载Client Portal Gateway
   ```bash
   # 从IBKR官网下载
...
- [API快速参考](./api_reference_quick.md) - 端点快速查询
- [交易API详细文档](./trading.md) - 完整API说明
- [账户管理API](./account_management.md) - 账户管理功能
