...
class TestCoinSpotRequestTickerData:
    ...
    def test_init_data(self):
        ...
        ticker = CoinSpotRequestTickerData(data, symbol_name="BTC", asset_type="SPOT", has_been_json_encoded=True)
        ticker.init_data()
    ...
    def test_get_all_data(self):
        ...
        ticker = CoinSpotRequestTickerData({}, symbol_name="BTC", asset_type="SPOT", has_been_json_encoded=True)
