...
| period | ENUM | 否 | K 线周期: min1, min5, min15, min30, hour1, hour3, hour4, hour6, hour12, day1, week1, month1 |
...
| client_order_id | STRING | 否 | 客户自定义订单 ID |
