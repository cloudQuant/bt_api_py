...
class ExchangeRegistry:
    ...
    _feed_classes = {}           # {"BINANCE___SWAP": BinanceRequestDataSwap, ...}
    _stream_classes = {}         # {"BINANCE___SWAP": {"market": cls, "account": cls, "kline": cls}}
    _exchange_data_classes = {}  # {"BINANCE___SWAP": BinanceExchangeDataSwap, ...}
    _balance_handlers = {}       # {"BINANCE___SWAP": handler_func, ...}

    @classmethod
    def register_feed(cls, exchange_name, feed_class):
        """注册 REST feed 类
    ...
    @classmethod
    def register_stream(cls, exchange_name, stream_type, stream_class):
        """注册流式数据类
    ...
    @classmethod
    def register_exchange_data(cls, exchange_name, exchange_data_class):
        """注册交易所配置类
        :param exchange_name: 交易所标识
    ...
    @classmethod
    def register_balance_handler(cls, exchange_name, handler_func):
        """注册余额解析处理函数
        :param exchange_name: 交易所标识
    ...
    @classmethod
    def create_feed(cls, exchange_name, data_queue, **kwargs):
        """根据交易所标识创建 feed 实例
        :param exchange_name: 交易所标识
    ...
    @classmethod
    def create_exchange_data(cls, exchange_name):
        """根据交易所标识创建交易所配置实例
        :param exchange_name: 交易所标识
    ...
    @classmethod
    def get_stream_classes(cls, exchange_name):
        """获取某个交易所的所有流式数据类
        :param exchange_name: 交易所标识
    ...
    @classmethod
    def get_stream_class(cls, exchange_name, stream_type):
        """获取某个交易所的某种流式数据类
        :param exchange_name: 交易所标识
    ...
    @classmethod
    def get_balance_handler(cls, exchange_name):
        """获取余额解析处理函数
        :param exchange_name: 交易所标识
    ...
    @classmethod
    def has_exchange(cls, exchange_name):
        """检查交易所是否已注册"""
