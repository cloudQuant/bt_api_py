...
1. **MUST Document Activation Decision**
...
1. **MUST Follow Simple Routing Logic**
...
1. **Discuss Agent's Activation Needs**
...
1. **User wants to change hasSidecar?**
   - Return to Step 3 to revise decision
   - Update plan accordingly

1. **Uncertain about routing?**
