...
## Response Example
  ...
  - [Event Description](</docs/derivatives/portfolio-margin/user-data-streams/Event-Futures-Balance-and-Position-Update#event-description>)
  - [Event Name](</docs/derivatives/portfolio-margin/user-data-streams/Event-Futures-Balance-and-Position-Update#event-name>)
  - [Update Speed](</docs/derivatives/portfolio-margin/user-data-streams/Event-Futures-Balance-and-Position-Update#update-speed>)
  - [Response Example](</docs/derivatives/portfolio-margin/user-data-streams/Event-Futures-Balance-and-Position-Update#response-example>)
