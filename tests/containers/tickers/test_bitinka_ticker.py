...
class TestBitinkaRequestTickerData:
    ...
    def test_init_data(self):
        ...
        ticker = BitinkaRequestTickerData(data, symbol_name="BTCUSD", asset_type="SPOT", has_been_json_encoded=True)
        ticker.init_data()
    ...
    def test_get_all_data(self):
        ...
        ticker = BitinkaRequestTickerData({}, symbol_name="BTCUSD", asset_type="SPOT", has_been_json_encoded=True)
