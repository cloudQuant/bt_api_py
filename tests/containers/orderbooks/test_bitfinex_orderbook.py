...
class TestBitfinexOrderBookData:
    ...
    def test_init_data(self):
        ...
        orderbook = BitfinexOrderBookData(data, symbol_name="BTCUSD", asset_type="SPOT", has_been_json_encoded=True)
        orderbook.init_data()
    ...
    def test_get_all_data(self):
        ...
        orderbook = BitfinexOrderBookData({}, symbol_name="BTCUSD", asset_type="SPOT", has_been_json_encoded=True)
