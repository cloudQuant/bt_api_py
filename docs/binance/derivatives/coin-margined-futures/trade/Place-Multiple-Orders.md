...
## Response Example
  ...
  - [API Description](</docs/derivatives/coin-margined-futures/trade/Place-Multiple-Orders#api-description>)
  - [HTTP 请求](</docs/derivatives/coin-margined-futures/trade/Place-Multiple-Orders#http 请求>)
  - [Request Weight](</docs/derivatives/coin-margined-futures/trade/Place-Multiple-Orders#request-weight>)
  - [Request Parameters](</docs/derivatives/coin-margined-futures/trade/Place-Multiple-Orders#request-parameters>)
  - [Response Example](</docs/derivatives/coin-margined-futures/trade/Place-Multiple-Orders#response-example>)
