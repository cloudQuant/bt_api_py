...
class TestOkxOrderBookData:
    ...
    def test_init_data(self):
        ...
        orderbook = OkxOrderBookData(data, symbol_name="BTC-USDT", asset_type="SPOT", has_been_json_encoded=True)
        orderbook.init_data()
    ...
    def test_get_all_data(self):
        ...
        orderbook = OkxOrderBookData({}, symbol_name="BTC-USDT", asset_type="SPOT", has_been_json_encoded=True)
