...
class TestHtxRequestOrderBookData:
    ...
    def test_init_data(self):
        ...
        orderbook = HtxRequestOrderBookData(data, symbol_name="btcusdt", asset_type="SPOT", has_been_json_encoded=True)
        orderbook.init_data()
    ...
    def test_get_all_data(self):
        ...
        orderbook = HtxRequestOrderBookData({}, symbol_name="btcusdt", asset_type="SPOT", has_been_json_encoded=True)
