...
- *参数**: `symbol` (必需), `limit` (可选, 默认 100, 最大 1000)
...
- *参数**: `symbol` (必需), `limit` (可选, 默认 500, 最大 1000)
...
| scale | STRING | 是 | K 线周期: 1/5/15/30/60/240/1D/1W |
...
| newClientOrderId | STRING | 否 | 客户端订单 ID |
