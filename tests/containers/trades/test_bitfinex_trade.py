...
class TestBitfinexRequestTradeData:
    ...
    def test_init_data_dict_format(self):
        ...
        data = [{"id": "123456", "price": "50000.0", "amount": "1.0", "timestamp": 1234567890, "side": "BUY"}]
        trade = BitfinexRequestTradeData(data, symbol_name="BTCUSD", asset_type="SPOT", has_been_json_encoded=True)
        trade.init_data()
    ...
    def test_get_all_data(self):
        """Test get_all_data."""
        trade = BitfinexRequestTradeData({}, symbol_name="BTCUSD", asset_type="SPOT", has_been_json_encoded=True)
