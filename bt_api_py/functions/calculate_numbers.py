...
def normalise_hedge_data_to_base(depth_data, params):
    ...
    if price_unit_equal:
        ...
        spot_bid_vol = [
            int(i * params["qty_percent"] / 100 / params["base_spot_qty_unit"])
            for i in spot_bid_vol
        ]
        spot_ask_vol = [
            int(i * params["qty_percent"] / 100 / params["base_spot_qty_unit"])
            for i in spot_ask_vol
        ]
