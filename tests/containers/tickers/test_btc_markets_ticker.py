...
class TestBtcMarketsRequestTickerData:
    ...
    def test_init_data(self):
        ...
        ticker = BtcMarketsRequestTickerData(data, symbol_name="BTC-AUD", asset_type="SPOT", has_been_json_encoded=True)
        ticker.init_data()
    ...
    def test_get_all_data(self):
        ...
        ticker = BtcMarketsRequestTickerData({}, symbol_name="BTC-AUD", asset_type="SPOT", has_been_json_encoded=True)
