...
class CoinExRequestData(Feed):
    ...
    def _generate_signature(self, timestamp, method, request_path, body=""):
        ...
        # CoinEx signature: timestamp + method + request_path + body + params
    ...
    def _get_headers(self, method, request_path, params=None, body=""):
        ...
        headers = {
            ...
            "X-COINEX-KEY": self._params.api_key,
            "X-COINEX-TIMESTAMP": str(timestamp),
            "X-COINEX-SIGNATURE": self._generate_signature(
    ...
    def request(self, path, params=None, body=None, extra_data=None, timeout=10):
        """HTTP request for CoinEx API."""
        method = path.split()[0] if " " in path else "GET"
        # Path already includes leading slash (e.g., "GET /spot/ticker")
