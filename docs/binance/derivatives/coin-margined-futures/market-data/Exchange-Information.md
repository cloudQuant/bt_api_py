...
## Response Example
  ...
  - [API Description](</docs/derivatives/coin-margined-futures/market-data/Exchange-Information#api-description>)
  - [HTTP Request](</docs/derivatives/coin-margined-futures/market-data/Exchange-Information#http-request>)
  - [Request Weight](</docs/derivatives/coin-margined-futures/market-data/Exchange-Information#request-weight>)
  - [Request Parameters](</docs/derivatives/coin-margined-futures/market-data/Exchange-Information#request-parameters>)
  - [Response Example](</docs/derivatives/coin-margined-futures/market-data/Exchange-Information#response-example>)
