...
def gmx_feed(mock_data_queue):
    ...
    with patch("bt_api_py.feeds.live_gmx.request_base.HttpClient"):
...
class TestGmxInit:
    ...
    def test_init_default_params(self, gmx_feed):
        ...
        assert gmx_feed.exchange_name == "GMX___DEX"
...
class TestGmxBasic:
    ...
    def test_get_pools(self, gmx_feed):
        ...
        assert hasattr(gmx_feed, "get_exchange_info")

    @pytest.mark.ticker
    def test_get_ticker(self, gmx_feed):
        """Test get_ticker method"""
        assert hasattr(gmx_feed, "get_tick")
