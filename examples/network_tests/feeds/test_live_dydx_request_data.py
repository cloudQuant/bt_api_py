...
class TestDydxTicker:
    ...
    def test_get_ticker_spot(self, dydx_spot):
        ...
        assert path == "GET /v4/perpetualMarkets"
...
class TestDydxBalance:
    ...
    def test_get_balance_spot(self, dydx_spot):
        ...
        assert path == "GET /v4/addresses/<placeholder>/subaccountNumber/<placeholder>"
    ...
    def test_balance_normalize_function_valid_data(self):
        ...
        assert result[0]["free_collateral"] == 5000.0
        assert result[0]["available_margin"] == 3000.0
        assert result[0]["position_margin"] == 200.0
        assert result[0]["margin_balance"] == 8000.0
