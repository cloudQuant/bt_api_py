...
class TestZebpayRequestTickerData:
    ...
    def test_init_data(self):
        ...
        ticker = ZebpayRequestTickerData(data, symbol_name="BTCINR", asset_type="SPOT", has_been_json_encoded=True)
        ticker.init_data()
    ...
    def test_get_all_data(self):
        ...
        ticker = ZebpayRequestTickerData({}, symbol_name="BTCINR", asset_type="SPOT", has_been_json_encoded=True)
