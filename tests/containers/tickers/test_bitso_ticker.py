...
class TestBitsoRequestTickerData:
    ...
    def test_init_data(self):
        ...
        ticker = BitsoRequestTickerData(data, symbol_name="btc_mxn", asset_type="SPOT", has_been_json_encoded=True)
        ticker.init_data()
    ...
    def test_get_all_data(self):
        """Test get_all_data."""
        ticker = BitsoRequestTickerData({}, symbol_name="btc_mxn", asset_type="SPOT", has_been_json_encoded=True)
