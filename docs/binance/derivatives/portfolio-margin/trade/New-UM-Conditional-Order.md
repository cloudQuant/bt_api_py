...
## Response Example
  ...
  * [API Description](</docs/derivatives/portfolio-margin/trade/New-UM-Conditional-Order#api-description>)
  * [HTTP Request](</docs/derivatives/portfolio-margin/trade/New-UM-Conditional-Order#http-request>)
  * [Request Weight](</docs/derivatives/portfolio-margin/trade/New-UM-Conditional-Order#request-weight>)
  * [Request Parameters](</docs/derivatives/portfolio-margin/trade/New-UM-Conditional-Order#request-parameters>)
  * [Response Example](</docs/derivatives/portfolio-margin/trade/New-UM-Conditional-Order#response-example>)
