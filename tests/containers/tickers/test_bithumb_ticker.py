"""Tests for BithumbRequestTickerData container."""
...
class TestBithumbRequestTickerData:
    """Tests for BithumbRequestTickerData."""

    def test_init(self):
        """Test initialization."""
        ticker = BithumbRequestTickerData({}, symbol_name="BTC", asset_type="SPOT")

        assert ticker.exchange_name == "BITHUMB"
