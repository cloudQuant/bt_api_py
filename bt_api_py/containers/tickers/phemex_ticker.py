...
class PhemexRequestTickerData(TickerData):
    ...
    def __init__(self, data: Dict[str, Any], symbol: str, asset_type: str, has_been_json_encoded=False):
        ...
        self.logger = SpdLogManager(
            "./logs/phemex_ticker.log", "ticker", 0, 0, False
        ).create_logger()
    ...
    def _unscale(self, value: Optional[int], scale: float) -> Optional[float]:
