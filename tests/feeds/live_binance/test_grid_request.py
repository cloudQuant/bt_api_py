...
def test_grid_request_futures_grid_cancel_order_params():
    ...
    path, params, extra_data = grid._futures_grid_cancel_order(
        symbol='BTC-USDT',
        order_id=12345
    )
...
def test_grid_request_get_futures_grid_orders_params():
    ...
    path, params, extra_data = grid._get_futures_grid_orders(
        symbol='BTC-USDT'
    )
...
def test_grid_request_get_futures_grid_position_params():
    ...
    path, params, extra_data = grid._get_futures_grid_position(
        symbol='BTC-USDT'
    )
...
def test_grid_request_get_futures_grid_income_params():
    ...
    path, params, extra_data = grid._get_futures_grid_income(
        symbol='BTC-USDT',
        limit=10
    )
